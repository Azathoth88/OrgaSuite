...
const getTranslations = (orgType, language) => {
  ...
  const commonTranslations = {
    ...
    'validation.invalidPhone': language === 'en' ? 'Invalid phone number' : 'Ungültige Telefonnummer',
    'validation.invalidIban': language === 'en' ? 'Invalid IBAN' : 'Ungültige IBAN',
    'validation.emailExists': language === 'en' ? 'Email address already exists' : 'E-Mail-Adresse bereits vergeben',
    'validation.memberNumberExists': language === 'en' ? 'Member number already exists' : 'Mitgliedsnummer bereits vergeben',
    
    // Member Form
    'members.basicInfo': language === 'en' ? 'Basic Information' : 'Grunddaten',
    'members.firstName': language === 'en' ? 'First Name' : 'Vorname',
    'members.lastName': language === 'en' ? 'Last Name' : 'Nachname',
    'members.addressInfo': language === 'en' ? 'Address' : 'Anschrift',
    'members.membershipInfo': language === 'en' ? 'Membership Data' : 'Mitgliedschaftsdaten',
    'members.customerInfo': language === 'en' ? 'Customer Data' : 'Kundendaten',
    'members.membershipType': language === 'en' ? 'Membership Type' : 'Mitgliedschaftstyp',
    'members.customerType': language === 'en' ? 'Customer Type' : 'Kundentyp',
    'members.paymentMethod': language === 'en' ? 'Payment Method' : 'Zahlungsart',
    ...
    // Member Types
    'members.fullMember': language === 'en' ? 'Full Member' : 'Vollmitglied',
    'members.supportingMember': language === 'en' ? 'Supporting Member' : 'Fördermitglied',
    'members.honoraryMember': language === 'en' ? 'Honorary Member' : 'Ehrenmitglied',
    'members.standardCustomer': language === 'en' ? 'Standard' : 'Standard',
    'members.premiumCustomer': language === 'en' ? 'Premium' : 'Premium',
    'members.vipCustomer': language === 'en' ? 'VIP' : 'VIP',
    
    // Payment Methods
    'members.directDebit': language === 'en' ? 'Direct Debit' : 'Lastschrift',
    'members.bankTransfer': language === 'en' ? 'Bank Transfer' : 'Überweisung',
    'members.cash': language === 'en' ? 'Cash' : 'Barzahlung',
    'members.paypal': language === 'en' ? 'PayPal' : 'PayPal',
    
    // Success/Error Messages
    'members.createSuccess': language === 'en' ? 'Member created successfully!' : 'Mitglied erfolgreich angelegt!',
    'members.updateSuccess': language === 'en' ? 'Member updated successfully!' : 'Mitglied erfolgreich aktualisiert!',
    'members.deleteSuccess': language === 'en' ? 'Member deleted successfully!' : 'Mitglied erfolgreich gelöscht!',
    'members.deleteError': language === 'en' ? 'Error deleting member' : 'Fehler beim Löschen des Mitglieds',
    'members.confirmDelete': language === 'en' ? 'Do you really want to delete' : 'Möchten Sie wirklich löschen'
  };
